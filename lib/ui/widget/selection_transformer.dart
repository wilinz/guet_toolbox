...
class SeparatedSelectionContainerDelegate
  ...
  void _updateLastEdgeEventsFromGeometries() {
    if (currentSelectionStartIndex != -1) {
      ...
      final startSelectionPoint = start.value.endSelectionPoint;
      if (startSelectionPoint == null) return;
      final Offset localStartEdge = startSelectionPoint.localPosition +
          Offset(0, -startSelectionPoint.lineHeight / 2);
    ...
    if (currentSelectionEndIndex != -1) {
      ...
      final endSelectionPoint = end.value.endSelectionPoint;
      if (endSelectionPoint == null) return;
      final Offset localEndEdge = endSelectionPoint.localPosition +
          Offset(0, -endSelectionPoint.lineHeight / 2);
