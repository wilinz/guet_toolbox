...
import 'package:guettoolbox/ui/page/course_detail/course_detail_vm.dart';
...
class CourseDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<CourseDetailViewModel>(
      ...
      child: _CourseDetailPage(schedule: schedule),
    );
  }
}

class _CourseDetailPage extends StatefulWidget {
  const _CourseDetailPage({Key? key, required this.schedule}) : super(key: key);
  final SemesterSchedule schedule;
